 ...
 *************************************************************
 ...
 "pushbuttons" over a BLE Bluetooth connection. In this version the Rover keeps a constant speed. the pushbuttons
 cause the Rover to perform a "Pirouette" or spin maneuver - one in the right direction and one in the left. 
 This code should work for a 2 motor Rover. You will have to designate the motors appropriately in the Define 
 Motor Port Section ~line 43. 
...
//x = -1 and y = -1 Back Diagonal Left
  ...
  motorLF->setSpeed(128);//50% Speed of opposing side motors
  motorLR->setSpeed(128);//50% Speed of opposing side motors
  motorRF->setSpeed(255);
  motorRR->setSpeed(255);
...
//x = 1 and y = -1 Backward Diagonal Right
  ...
  motorLF->setSpeed(255);
  motorLR->setSpeed(255);
  motorRF->setSpeed(128);//50% Speed of opposing side motors
  motorRR->setSpeed(128);//50% Speed of opposing side motors
